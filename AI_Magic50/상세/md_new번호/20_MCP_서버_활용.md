...
id: 20
title: "MCP 서버 활용하기"
subtitle: "외부 시스템(Notion·Slack·DB·OS·디자인툴 등)과 데이터 레벨로 직접 통신하는 프로토콜"
type: B
group_id: 3
group_name: "실행 방법"
order_in_group: 7
...
→ 두 축이 직교한다. 한쪽으로 부족한 작업은 다른 쪽으로 채운다. 본인은 이 구분을 *오래 헷갈려서 손해 본 부분* 이라 본다 — Slack 자동화를 다른 CLI로 풀려고 한참 헤매다 MCP 한 줄로 끝난 적이 여러 번 있다.
